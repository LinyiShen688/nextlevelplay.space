  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-indigo-900 via-purple-900 to-pink-900 text-white">
      ...
      <div className="container mx-auto px-4 mb-8">
        {user ? <UserProfile user={user} onSignOut={signOut} /> : <Auth />}
      </div>
            ...
            >
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <Sparkles className={`w-5 h-5 ${selectedSign === index ? 'text-yellow-400' : 'text-gray-400'}`} />
                </div>
      ...
      {selectedSign && (
        <div className="mt-8 p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
          ...
          <p className="text-gray-600 dark:text-gray-300">{fortune}</p>
          <button
